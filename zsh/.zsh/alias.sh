...
alias la='exa -laF --icons --group-directories-first --time-style long-iso --grid'
alias la-git='exa -laF --icons --group-directories-first --time-style long-iso --git --git-ignore --grid'
